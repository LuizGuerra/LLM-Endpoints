...
# This is just the original OpenAI_OrganizationAPI class with some modifications
# to make it work with the DeepSeek API
# The original class is in src/api/openai_api.py
class DeepSeekAPI:
...
# Call this function to test Keys and IDs, and if paid models are available
  ...
  def run_verification(self):
    """
    Runs verification tests for newer models API routes and displays the results.
    """
    ...
    # Show result
    print('✅ Everything\'s running!' if main_route_result else '⛔ Problem detected!')
  # Is not supporting stream methods yet

  def query(self, prompt: str, system_prompt: Union[str, None] = None, model: str = 'deepseek-chat') -> list[str]:
    """
    ...
    - system_prompt (Union[None, str]): The system prompt to use. If None, defaults to "You are a helpful assistant."
    - model: A string representing the model to be used for processing the prompt. Defaults to deepseek-chat
  ...
  def single_thread_queries(self, prompts: list[str], system_prompt: Union[str, None] = None, model: str = 'deepseek-chat', query_output_path: str = None, query_output_filename: str = 'result', query_simple_questions: Union[list[str], None] = None) -> zip:
    """
    ...
    - system_prompt (Union[None, str]): The system prompt to use. If None, defaults to "You are a helpful assistant."
    - model: A string representing the model to be used for processing the prompts (default is 'deepseek-chat').
  ...
  def multi_thread_queries(self, prompts: list[str], system_prompt: Union[str, None] = None, model: str = 'deepseek-chat', query_output_path: str = None, query_output_filename: str = 'result') -> list[str, str]:
    """
  ...
  def multi_turn_query(self, messages: list[tuple[str, str]], system_prompt: Union[None, str] = None, model: str = 'deepseek-chat') -> Union[None, str]:
    """
    ...
    - system_prompt (Union[None, str]): The system prompt to use. If None, defaults to "You are a helpful assistant."
    - model (str): The name of the model to use for the query. Defaults to 'deepseek-chat'.
